    ...
    <>
      <Wrap>
        ...
        <Nav>
          ...
          <ExternalNavLink href="https://discord.gg/krstay" target="_blank" rel="noopener noreferrer">
            디스코드
          </ExternalNavLink>
        </Nav>
      ...
      <MobileMenu $open={open}>
        ...
        <MobileExternalLink href="https://discord.gg/krstay" target="_blank" rel="noopener noreferrer">
          디스코드
        </MobileExternalLink>
        {session ? (
